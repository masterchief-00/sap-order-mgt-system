...
sap.ui.require(
  [
    ...
    "ns/products/test/integration/ProductsListJourney",
    "ns/products/test/integration/ProductsObjectPageJourney",
    "ns/products/test/integration/Products_reviewsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
